...
run_test_args "slow" "3 2 1 4" "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_args "slow" "5 3 2 4 6 1" "Enter sequence of integers, each followed by a space: Number of inversions: 5"
...
run_test_args "slow" "4 3 2 1 5 7 8 9" "Enter sequence of integers, each followed by a space: Number of inversions: 6"
run_test_args "slow" "$(echo {1..10000})" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "slow" "$(echo {1..1000})" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "slow" "$(echo {1000..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 499500"
run_test_args "slow" "10 8 1 5 3 2 6 4 7 9" "Enter sequence of integers, each followed by a space: Number of inversions: 21"
...
run_test_args "" "3 2 1 4" "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_args "" "5 3 2 4 6 1" "Enter sequence of integers, each followed by a space: Number of inversions: 5"
...
run_test_args "" "4 3 2 1 5 7 8 9" "Enter sequence of integers, each followed by a space: Number of inversions: 6"
run_test_args "" "$(echo {1..10000})" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "" "$(echo {1..1000})" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "" "$(echo {1000..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 499500"
run_test_args "" "10 8 1 5 3 2 6 4 7 9" "Enter sequence of integers, each followed by a space: Number of inversions: 21"
